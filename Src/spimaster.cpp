...
#define SPIM_SYSLOG(fmt, ...)    MURASAKI_SYSLOG( this, kfaSpiMaster, kseDebug, fmt, ##__VA_ARGS__)
        ...
        spi_spec->AssertCs();
        {
            ...
            switch (interrupt_status_)
            {
                ...
                case murasaki::kspisModeCRC:
                    MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "CRC error")
                    break;
                case murasaki::kspisOverflow:
                    MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "DMA overflow / underflow")
                    break;
                case murasaki::kspisFrameError:
                    MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "Frame error")
                    break;
                case murasaki::kspisDMA:
                    MURASAKI_SYSLOG(this, kfaSpiMaster, kseError, "DMA error")
                ...
                case murasaki::kspisErrorFlag:
                    MURASAKI_SYSLOG(this, kfaSpiMaster, kseError, "Unknown error flag,  Peripheral re-initialized")
                    // Desable SPI to try to clear the current error status. Then, re-enable.
                    HAL_SPI_DeInit(peripheral_);
                    HAL_SPI_Init(peripheral_);
                    break;
                case murasaki::ki2csTimeOut:
                    MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "Receive timeout. DMA stopped")
...
bool SpiMaster::HandleError(void* ptr)
{
    ...
    if (this->Match(ptr)) {
        ...
        if (peripheral_->ErrorCode & HAL_SPI_ERROR_CRC) {
            MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "HAL_SPI_ERROR_CRC");
            ...
            MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "HAL_SPI_ERROR_OVR");
            ...
            MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "HAL_SPI_ERROR_FRE");
            ...
            MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "HAL_SPI_ERROR_DMA");
            ...
            MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "HAL_SPI_ERROR_FLAG");
            ...
            MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "HAL_SPI_ERROR_ABORT");
        ...
        {
            MURASAKI_SYSLOG(this, kfaSpiMaster, kseWarning, "Unknown error interrupt")
