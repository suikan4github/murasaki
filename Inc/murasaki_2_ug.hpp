 ...
 *  For example, the following is the sample of a callback.
 *
 *  @code
 ...
 *  The EXTI peripheral may raise the interrupt before the platform peripherals are ready.
 *
 ...
 *  @endcode
 *
 *  Note that the USER_Btn_Pin constant in the above example is generated by CubeIDE, when customer labels "USER_Btn" to some EXTI input pin.
 *
