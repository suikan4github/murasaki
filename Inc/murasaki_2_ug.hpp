 ...
 * file is generated by CubeIDE. You can find USE_FULL_ASERT macro as comment out.
 ...
 *
 * The I2C slave is much easier than master, because it doesn't need to specify the slave address. The I2C slave device address is given by CubeIDE.
 * @code
 *        uint8_t data[5];
 *        murasaki::I2cStatus stat;
 *
 ...
 * CubeIDE generated code. 2 out of 3 flows are for debugging. Only 1 flow have to be
