 ...
 * @details
 * A Singleton design registory. This is Murasaki internal only. Do not use in the application.
 *
 * This class object stores the list of the interrupt callback responding objects.
 * The registration is done in the construction phase. So, it is invisible from the
 ...
 *
 * The EXTI is not supprted by this class.
 *
