 ...
 * \endcode
 * Where hi2c3 is the handle generated by CubeIDE for I2C3 peripheral. To use this class,
 * the I2C peripheral have to be configured to use the interrupt functionality without DMA.
 * The bit rate and the peripheral address should be configured by the CubeIDE.
 *
